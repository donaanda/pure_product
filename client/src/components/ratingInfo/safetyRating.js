        ...
        return (
            <section>
                ...
                <div className="site-about-container">
                    ...
                    <p className="text-content-desktop">Our safety rating is based on data from Environmental Working Group's analysis. It represents overall safety based on ingredients in a product as it relates to the average human body and the envrionment. It differs from the gentle rating as it does not rate products that can cause irritation (such as many essential oils) as negative, while the gentle rating addresses irritation.</p>
