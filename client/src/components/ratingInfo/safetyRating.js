        ...
        return (
            <section>
                ...
                <div className="site-about-container safety-rating-container">
                    ...
                    <p className="text-content-desktop">Our safety rating is based on data from Environmental Working Group's analysis. It represents overall safety based on ingredients in a product as it relates to the average human body and the environment. It differs from the gentle rating as it does not rate products that can cause irritation (such as many essential oils) as negative, while the gentle rating addresses irritation.</p>
                    <p className="text-content-desktop"> All data should be taken with a grain of salt, as the amount of data available on each ingredient can range from robust to limited. Additionally, ever person has different tolerances, allergies, and other limiting factors in which products they can use, and it’s always best to choose products based on your individual needs. We attempt to do our best to organize the data in the most user friendly way possible, but as always, it’s important to consult your doctor when using any new products, as well as listen to your own skin and body when trying something new.</p><br />
