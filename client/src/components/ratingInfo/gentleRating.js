            ...
            <section>
                ...
                <div className="site-about-container gentle-rating-container">
                    <Link to="/safety_rating">
                        <button className="btn rate-button">See Safety Rating</button>
                    </Link>
