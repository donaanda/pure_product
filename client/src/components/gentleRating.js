        ...
        return (
            <section>
                ...
                <div className="site-about-container">
                    ...
                    <p className="scale-text"><span className="green">Best</span> <span className="yellow darken-2">Good</span > <span className="orange">Average</span> <span className="red">Poor</span></p>
