        ...
        return (
            <section>
                ...
                <div className="site-about-container">
                    ...
                    <h3>Safety Rating</h3>
                    <p className="scale-text"><span className={this.colorizeSafetyNum("1")}>1</span><span className={this.colorizeSafetyNum("2")}>2</span><span className={this.colorizeSafetyNum("3")}>3</span><span className={this.colorizeSafetyNum("4")}>4</span><span className={this.colorizeSafetyNum("5")}>5</span><span className={this.colorizeSafetyNum("6")}>6</span><span className={this.colorizeSafetyNum("7")}>7</span><span className={this.colorizeSafetyNum("8")}>8</span><span className={this.colorizeSafetyNum("9")}>9</span><span className={this.colorizeSafetyNum("10")}>10</span></p>
