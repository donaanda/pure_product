...
const FAQ = () => {
    return (
        <section className="FAQ">
            ...
            <h1>FAQ</h1>
            <h2>Does Pure Product Sell Products?</h2>
            <p>No. We are a purely informational site.</p>
            <h2>How does Pure Product analyze ingredients?</h2>
